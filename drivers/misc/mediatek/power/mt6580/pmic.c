...
void PMIC_INIT_SETTING_V1(void)
{
		...
		ret = pmic_config_interface(0x40,0x0,0x1,0); //add 
		ret = pmic_config_interface(0x40,0x0,0x1,1); //add 
		ret = pmic_config_interface(0x40,0x1,0x1,2); //add 
		ret = pmic_config_interface(0x16c,0x1,0x1,3); //add 
