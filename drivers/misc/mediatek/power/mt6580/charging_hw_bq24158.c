...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
   ...
   // bq24158_config_interface_liao(0x04,0x1A); //146mA
	...
	// ISAFE =56mO =>06H B7~4:0000->668mA,0001->789,0010->910mA,0011->1032mA,0100->1153mA,0101->1275mA,0111->1518mA,1111->2489mA
	// VSAFE = 4.38V
        bq24158_config_interface_liao(0x06,0x39); 
		//04H, for 68mO, bit2-bit0, 001: 100mA, 010:146mA, 011:200mA, 100:250mA, 101:300mA, 110: 350, 111:400mA
		//04H, for 56mO, bit2-bit0, 001: 121mA, 010:182mA, 011:242mA, 100:303mA, 101:364mA, 110: 425, 111:485mA
		bq24158_config_interface_liao(0x04,0x1a);
#else
		bq24158_config_interface_liao(0x06,0x71); // ISAFE = 1250mA, VSAFE = 4.22V
		bq24158_config_interface_liao(0x04,0x1A); //bit2-bit0, 010:146mA, 011:200mA
	#endif
