...
#define MAIN_CAMERA_ID_PIN GPIO_CAMERA_KEY2_PIN //hcz
...
void GC0310_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        default:
			GC0310_write_cmos_sensor(0xfe, 0x00); 	
			GC0310_write_cmos_sensor(0xd1, 0x32);//34
...
void GC0310_Sensor_Init(void)
{
    ...
    GC0310_write_cmos_sensor(0xf7,0x1b);
    GC0310_write_cmos_sensor(0xf8,0x03);  // from 03 to 04
	...
	GC0310_write_cmos_sensor(0x05,0x00);  // 40      20     
    ...
    GC0310_write_cmos_sensor(0x44,0x01); // 02 yuv  00
    GC0310_write_cmos_sensor(0x45,0xa8); // from a8 - a4 a4-a0
    ...
    GC0310_write_cmos_sensor(0xce,0xfa); 
    GC0310_write_cmos_sensor(0xcf,0xff);  */
    	GC0310_write_cmos_sensor(0xfe , 0x00);  //guodengxiang_melody
			GC0310_write_cmos_sensor(0xbf , 0x00);
			GC0310_write_cmos_sensor(0xc0 , 0x12);
			GC0310_write_cmos_sensor(0xc1 , 0x29);
			GC0310_write_cmos_sensor(0xc2 , 0x42);
			...
			GC0310_write_cmos_sensor(0xc8 , 0xc8);
			GC0310_write_cmos_sensor(0xc9 , 0xd7);
			GC0310_write_cmos_sensor(0xca , 0xe1);
			GC0310_write_cmos_sensor(0xcb , 0xe9);
			GC0310_write_cmos_sensor(0xcc , 0xef);
    ...
    GC0310_write_cmos_sensor(0xd0,0x40); 
    GC0310_write_cmos_sensor(0xd1,0x32); //34
    GC0310_write_cmos_sensor(0xd2,0x32); //34 melody
    GC0310_write_cmos_sensor(0xd3,0x40); 
    ...
    */
      GC0310_write_cmos_sensor(0xfe , 0x01);		//awb guodengxiang_melody
			GC0310_write_cmos_sensor(0x1c , 0x91);  
			GC0310_write_cmos_sensor(0x21 , 0x15);  
			GC0310_write_cmos_sensor(0x50 , 0x80);  
			GC0310_write_cmos_sensor(0x56 , 0x06); //04 betty
			GC0310_write_cmos_sensor(0x58 , 0x04); //add betty
			GC0310_write_cmos_sensor(0x59 , 0x08);  
			...
			GC0310_write_cmos_sensor(0x6d , 0x02);  
			GC0310_write_cmos_sensor(0x6e , 0x00);  //e0 betty
			GC0310_write_cmos_sensor(0x6f , 0x50); //80 betty 
			GC0310_write_cmos_sensor(0x76 , 0x80); 

			GC0310_write_cmos_sensor(0x78 , 0xe0); //af betty 
			GC0310_write_cmos_sensor(0x79 , 0x75); 
			GC0310_write_cmos_sensor(0x7a , 0x40); 
			GC0310_write_cmos_sensor(0x7b , 0x50); 	
			GC0310_write_cmos_sensor(0x7c , 0x0c); 
  
			GC0310_write_cmos_sensor(0xfe , 0x01); //xuan kuang////
			GC0310_write_cmos_sensor(0x90 , 0x00); 
			GC0310_write_cmos_sensor(0x91 , 0x00); 
			GC0310_write_cmos_sensor(0x92 , 0xff); 
			GC0310_write_cmos_sensor(0x93 , 0xeb); 
			GC0310_write_cmos_sensor(0x95 , 0x24); 
			GC0310_write_cmos_sensor(0x96 , 0x00); 
			GC0310_write_cmos_sensor(0x97 , 0x4d); 
			GC0310_write_cmos_sensor(0x98 , 0x23); 
			GC0310_write_cmos_sensor(0x9a , 0x4c); 
			GC0310_write_cmos_sensor(0x9b , 0x23); 
			GC0310_write_cmos_sensor(0x9c , 0x83); 
			GC0310_write_cmos_sensor(0x9d , 0x4c); 
			GC0310_write_cmos_sensor(0x9f , 0xa3); 
			GC0310_write_cmos_sensor(0xa0 , 0x84); 
			GC0310_write_cmos_sensor(0xa1 , 0x00); 
			GC0310_write_cmos_sensor(0xa2 , 0x00); 
			GC0310_write_cmos_sensor(0x86 , 0x00); 
			GC0310_write_cmos_sensor(0x87 , 0x00); 
			GC0310_write_cmos_sensor(0x88 , 0x00); 
			GC0310_write_cmos_sensor(0x89 , 0x00); 
			GC0310_write_cmos_sensor(0xa4 , 0x00); 
			GC0310_write_cmos_sensor(0xa5 , 0x00); 
			GC0310_write_cmos_sensor(0xa6 , 0xc1); 
			GC0310_write_cmos_sensor(0xa7 , 0x99); 
			GC0310_write_cmos_sensor(0xa9 , 0xc9); 
			GC0310_write_cmos_sensor(0xaa , 0x8e); 
			GC0310_write_cmos_sensor(0xab , 0xa8); 
			GC0310_write_cmos_sensor(0xac , 0x81); 
			GC0310_write_cmos_sensor(0xae , 0xc9); 
			GC0310_write_cmos_sensor(0xaf , 0xa9); 
			GC0310_write_cmos_sensor(0xb0 , 0xd3); 
			GC0310_write_cmos_sensor(0xb1 , 0xa2); 
			GC0310_write_cmos_sensor(0xb3 , 0xd4); 
			GC0310_write_cmos_sensor(0xb4 , 0xa0); 
			GC0310_write_cmos_sensor(0xb5 , 0x00); 
			GC0310_write_cmos_sensor(0xb6 , 0x00); 
			GC0310_write_cmos_sensor(0x8b , 0x00); 
			GC0310_write_cmos_sensor(0x8c , 0x00); 
			GC0310_write_cmos_sensor(0x8d , 0x00); 
			GC0310_write_cmos_sensor(0x8e , 0x00); 
			GC0310_write_cmos_sensor(0x94 , 0x50); 
			GC0310_write_cmos_sensor(0x99 , 0xaa); 
			GC0310_write_cmos_sensor(0x9e , 0xaa); 
			GC0310_write_cmos_sensor(0xa3 , 0x0a); 
			GC0310_write_cmos_sensor(0x8a , 0x00); 
			GC0310_write_cmos_sensor(0xa8 , 0x50); 
			GC0310_write_cmos_sensor(0xad , 0x55); 
			GC0310_write_cmos_sensor(0xb2 , 0x55); 
			GC0310_write_cmos_sensor(0xb7 , 0x05); 
			GC0310_write_cmos_sensor(0x8f , 0x00); 
			GC0310_write_cmos_sensor(0xb8 , 0xdd); 
			GC0310_write_cmos_sensor(0xb9 , 0x81); 
 ...
 /*
    ...
    */
    	GC0310_write_cmos_sensor(0xfe , 0x01);
			GC0310_write_cmos_sensor(0xd0 , 0x31);  //31
			GC0310_write_cmos_sensor(0xd1 , 0x00);
			GC0310_write_cmos_sensor(0xd2 , 0x08); //08
			GC0310_write_cmos_sensor(0xd3 , 0x05);  //00
			GC0310_write_cmos_sensor(0xd4 , 0x40);
			GC0310_write_cmos_sensor(0xd5 , 0x00);  //fd
			GC0310_write_cmos_sensor(0xd6 , 0x28);
			GC0310_write_cmos_sensor(0xd7 , 0xfc);//00
			GC0310_write_cmos_sensor(0xd8 , 0x02);
			GC0310_write_cmos_sensor(0xd9 , 0x16);
			GC0310_write_cmos_sensor(0xda , 0x39);
			GC0310_write_cmos_sensor(0xdb , 0xf8);
...
UINT32 GC0310GetSensorID(UINT32 *sensorID)
{
    ...
    do {
        *sensorID=((GC0310_read_cmos_sensor(0xf0)<< 8)|GC0310_read_cmos_sensor(0xf1));
        ...
        {
			                //add by hcz
				mt_set_gpio_dir(MAIN_CAMERA_ID_PIN, GPIO_DIR_IN);
				mt_set_gpio_mode(MAIN_CAMERA_ID_PIN, GPIO_MODE_00);	
				msleep(2);
				if(mt_get_gpio_in(MAIN_CAMERA_ID_PIN)==1)  //sijichun module
				{		
					printk("hcz sijichun cam\r\n");
		           
					*sensorID = GC0310_SENSOR_ID;	
		            return ERROR_NONE;
				}
				else
				{					
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_YUV_CMD:
        GC0310YUVSensorSetting((FEATURE_ID)*pFeatureData, *(pFeatureData+1));
...
//		SENSORDB("[GC0310] Enter SENSOR_CMD_SET_VIDEO_FRAME_RATE\n");
	...
	GC0310_MIPI_GetDelayInfo(*pFeatureData);
    break;

    case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
         SENSORDB("[GC0310] F_GET_DEFAULT_FRAME_RATE_BY_SCENARIO\n");
         GC0310_MIPI_GetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData, (MUINT32 *)(uintptr_t)(*(pFeatureData+1)));
	...
	case SENSOR_FEATURE_SET_YUV_3A_CMD:
		 ...
		 GC0310_3ACtrl((ACDK_SENSOR_3A_LOCK_ENUM)*pFeatureData);
	...
	case SENSOR_FEATURE_GET_EXIF_INFO:
		 ...
		 //GC0310_MIPI_GetExifInfo(*ppFeatureData);/////////////////fhjf
		 break;


	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		 SENSORDB("[GC0310] F_GET_AE_AWB_LOCK_INFO\n");
		  GC0310_MIPI_get_AEAWB_lock((*pFeatureData),*(pFeatureData+1));
