...
#endif
#if defined(S5K4H6YC_MIPI_RAW)
    {S5K4H6YC_SENSOR_ID, SENSOR_DRVNAME_S5K4H6YC_MIPI_RAW, S5K4H6YC_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(GC0311_MIPI_YUV)
    {GC0311_SENSOR_ID, SENSOR_DRVNAME_GC0311_MIPI_YUV,GC0311_YUV_SensorInit},
#endif
