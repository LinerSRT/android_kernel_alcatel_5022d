...
#if (1)
bool is_mtkfb_early_suspended_state = FALSE;
bool get_mtkfb_early_suspended_state(void)
{
	return is_mtkfb_early_suspended_state;
}
EXPORT_SYMBOL(get_mtkfb_early_suspended_state);
#endif
