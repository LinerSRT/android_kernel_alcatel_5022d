...
#define STK_LT_N_CT     47
#define STK_HT_N_CT     55
...
static int PS_MAX_XTALK	= 500;//500;
static int PS_l_offset	= 28;//83;//100;  28
static int PS_h_offset	=  73;//177;//150;  73
#endif
/*----------------------------------------------------------------------------*/
...
static int stk_ps_tune_zero_final(struct stk3x1x_priv *obj)
{
	...
	if((obj->ps_stat_data[1] > STK_LT_DEF) || (data<20))
	{
		obj->ps_high_thd_boot = STK_HT_DEF;
		obj->ps_low_thd_boot = STK_LT_DEF;	
		obj->boot_cali = 0;
