...
#define PROC_NODE_SDCARD_UPDATE   "sdcard_update"
...
extern ssize_t DrvMainFirmwareChipTypeShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareChipTypeStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
...
extern ssize_t DrvMainFirmwareGestureDebugShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareGestureDebugStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
...
extern ssize_t DrvMainFirmwareGestureInforShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareGestureInforStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
...
extern ssize_t DrvMainFirmwareSetDebugValueShow(struct device *pDevice, struct device_attribute *pAttr, char *pBuf);
extern ssize_t DrvMainFirmwareSetDebugValueStore(struct device *pDevice, struct device_attribute *pAttr, const char *pBuf, size_t nSize);
...
extern s32 DrvMainProcfsFirmwareSdCardUpdateShow(char *page, char **start, off_t off, int count, int *eof, void *data);
extern s32 DrvMainProcfsFirmwareSdCardUpdateStore(struct file *file, const char *buffer, unsigned long count, void *data);
