...
#ifdef TPD_PROXIMITY
extern u8 MSG_tpd_proximity_detect;
#endif
...
//        mdelay(100);
        ...
        RegSet16BitValue(0x1150, 0x1111); 

        szDbBusTxData[0] = 0x10;
        szDbBusTxData[1] = 0x11;
        szDbBusTxData[2] = 0x50;
        ...
        IicWriteData(SLAVE_I2C_ID_DBBUS, &szDbBusTxData[0], 3+6);   // write 0xFFFF for reg 0x115C~0x115E 
...
#if 1
		szDbBusTxData[1] = 0x1f;
		szDbBusTxData[2] = 0xff;
		//szDbBusTxData[1]和szDbBusTxData[2]中的每一位代表一个手势，全写1表示所有手势都被打开
#endif
